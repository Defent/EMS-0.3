...
/*
	...
	These settings are what I use on my server and it seems balanced enough.
*/
...
DZMSBlacklistZones = [
	[[0,0,0],500],
	//[[06325,07807,0],1000] // Gives stary a 1000 raidus blacklisted zone, missions dont spawn close to it.
];
